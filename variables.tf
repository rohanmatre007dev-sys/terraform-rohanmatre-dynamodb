...
variable "ignore_changes_global_secondary_index" {
  description = "Whether to ignore changes lifecycle to global secondary indices, useful for provisioned tables with scaling. NOTE: enabling this after table creation causes a table recreation."
  type        = bool
  default     = false
}
...
variable "autoscaling_enabled" {
  description = "Whether or not to enable autoscaling. NOTE: enabling or disabling this causes the table to be recreated. See module README for details."
  type        = bool
  default     = false
}
